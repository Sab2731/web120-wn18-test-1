...
<html>
<head>
<title>WEB120 Portal -William's WebPage!</title>
...
<div class="wrapper">
<header>
  <h1><a href="index.php"><i class="logo fa <?=$logo?>"></i>putting CSS MeunMarker styles Web Dev Examples and more !</a></h1>
  ...
  <ul>
     ...
     <li><a href="aia.php"><span>AIA</span></a></li>
